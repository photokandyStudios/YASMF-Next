define( [ "yasmf", "app/views/DemoListView" ], function ( _y, DemoListView ) {
  ...
  APP.start = function () {
    ...
    homeTab.initWithOptions( {
      tag: "div",
      class: "ui-container home",
      title: "Home"
    } );
    var gettingStartedTab = new _y.UI.ViewContainer();
    gettingStartedTab.initWithOptions( {
      tag: "div",
      class: "ui-container home",
      title: "Getting Started"
    } );
    var documentationTab = new _y.UI.ViewContainer();
    documentationTab.initWithOptions( {
      tag: "div",
      class: "ui-container documentation",
      title: "Documentation"
    } );
    var downloadTab = new _y.UI.ViewContainer();
    downloadTab.initWithOptions( {
      tag: "div",
      class: "ui-container download",
      title: "Download"
    } );
    var aboutTab = new _y.UI.ViewContainer();
    aboutTab.initWithOptions( {
      tag: "div",
      class: "ui-container about",
      title: "About"
    } );
    var aTabViewController = new _y.UI.TabViewController();
    aTabViewController.initWithOptions( {
      barPosition: _y.UI.TabViewController.BAR_POSITION.top,
